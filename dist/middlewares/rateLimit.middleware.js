...
exports.webhookRateLimit = exports.strictRateLimit = exports.apiRateLimit = exports.authRateLimit = void 0;
...
function rateLimitMiddleware(options) {
    ...
    }, standardHeaders = true, legacyHeaders = false, skipSuccessfulRequests = false, skipFailedRequests = false, keyGenerator = defaultKeyGenerator } = options;
    return (req, res, next) => {
 ...
 */
exports.strictRateLimit = rateLimitMiddleware({
 ...
 */
exports.webhookRateLimit = rateLimitMiddleware({
...
function clearRateLimitStore() {
    ...
    logger_1.default.info('Rate limit store cleared');
}
/**
